<template>
    <div class="bg-purple-200 py-5 h-screen">
        <div class="container mx-auto">
            ...
            <h3 class=" font-semibold text-3xl text-purple-700 mb-4">Edit User</h3>
            ...
            <div class="shadow-md rounded-lg p-5 bg-purple-100">
                <form>
                    ...
                    <a class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer"
